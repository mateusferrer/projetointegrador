...
public class MenuFrm implements Serializable {
    ...
    /**
     * Navega dinamicamente para um item de menu. Utilizado para disparar dinamicamente um método de entrada
     * em ManagedBean e retornar para um endereço de navegação JSF.
